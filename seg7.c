...
#define PORT            GPIO_PORTA_BASE        // The base address of the I2C port (ORIGINALLY PORTA)
#define CLK                GPIO_PIN_6            // The 8-bit pin value (mask format) for clock **PC5 & PC6 (ORIGINALLY PA6 & PA7)**
...
// the CLK and DIO pins of I2C, which are PB2 and PB4, respectively. However, TiM1637 is NOT I2C
// compatible and thus we have to use PB2 and PB4 as GPIO pins (and use bit banging to emulate
